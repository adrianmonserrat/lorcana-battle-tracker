...
export function InitialTurnStats({ matches }: InitialTurnStatsProps) {
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-xl font-semibold">Estadísticas por Turno Inicial</h3>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* OTP Stats */}
        <Card>
          <CardHeader className="pb-4">
            <CardTitle className="text-lg text-blue-600">OTP (On the Play)</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <p className="text-sm text-muted-foreground">Total</p>
                <p className="text-2xl font-bold">{otpMatches.length}</p>
              </div>
              <div>
        ...
        <Card>
          <CardHeader className="pb-4">
            <CardTitle className="text-lg text-purple-600">OTD (On the Draw)</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <p className="text-sm text-muted-foreground">Total</p>
                <p className="text-2xl font-bold">{otdMatches.length}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">V / E / D</p>
                <p className="text-lg font-semibold">
