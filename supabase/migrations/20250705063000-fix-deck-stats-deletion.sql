...
-- Agregar política para permitir eliminar estadísticas de mazos
CREATE POLICY "Users can delete their own deck statistics" 
  ON public.deck_statistics 
  FOR DELETE 
  USING (auth.uid() = user_id);

-- Función para recalcular estadísticas de mazo basado en las partidas existentes
...
-- Función trigger para recalcular al eliminar partidas
...
-- Crear trigger para manejar eliminaciones
